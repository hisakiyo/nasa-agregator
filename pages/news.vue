  ...
  <div class="bg-slate-900 py-20 w-full">
    ...
    <ul class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 mt-4 lg:gap-4 px-10">
      <li v-for="article in articles" :key="article.id">
        <nuxt-link :to="localePath(`/articles/${article.id}/`)" class="w-full h-full mt-5 mb-2 lg:mb-8 px-6 py-4 bg-slate-800 shadow-lg overflow-hidden ring-1 ring-white/10 hover:ring-white/20 cursor-pointer ring-inset">
